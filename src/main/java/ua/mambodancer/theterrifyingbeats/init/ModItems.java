...
//import ua.mambodancer.theterrifyingbeats.blocks.crops.ItemCathalyzatorSeeds;
...
public class ModItems {
	...
	public static final ToolMaterial BANEFUL = EnumHelper.addToolMaterial("baneful", 3, 1500, 10.0f*3, 20, 30*3);
	...
	//ITEMS
	public static final Item THE_TERRIFYING_INGOT = new ItemBase(Reference.MOD_ID + ":" + "theterrifyingingot",64);
	public static final Item CATHALYZATOR = new ItemBase(Reference.MOD_ID + ":" + "cathalyzator",64);
	public static final Item CATHALYZATOR_INGOT = new ItemBase(Reference.MOD_ID + ":" + "cathalyzatoringot",64);
	public static final Item INFUSED_STAR = new ItemBase(Reference.MOD_ID + ":" + "infusedstar",64);
	public static final Item UNINFUSED_STAR = new ItemBase(Reference.MOD_ID + ":" + "uninfusedstar",64);
	public static final Item UNINFUSED_PICK_AXE= new ItemBase(Reference.MOD_ID + ":" + "uninfusedpickaxe",1);
	public static final Item BANEFUL_BLADE= new ItemBase(Reference.MOD_ID + ":" + "banefullightblade",1);
	public static final Item BANEFUL_BLADE_RUCHKA= new ItemBase(Reference.MOD_ID + ":" + "banefullightruchka",1);
//	public static final Item CATHALYZATOR_ESSENCE= new ItemBase(Reference.MOD_ID + ":" + "cathalyzatoressence");
//	public static final Item CATHALYZATOR_SEEDS= new ItemCathalyzatorSeeds();
...
//	public static final Item THE_TERRIFYING_SHOVEL = new ToolShovel("theterrifyingshovel_terrifying",TOOL_TERRIFYING);
	public static final Item THE_TERRIFYING_SWORD = new ToolSword(Reference.MOD_ID + ":" + "sword_terrifying",TOOL_TERRIFYINGX3);
	public static final Item BANEFUL_LIGHT = new ToolSword(Reference.MOD_ID + ":" + "baneful_light",BANEFUL);
	//ARMOR
