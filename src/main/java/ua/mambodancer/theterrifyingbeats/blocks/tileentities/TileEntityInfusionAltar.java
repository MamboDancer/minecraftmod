...
public class TileEntityInfusionAltar extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.infusionaltar";
	}
	...
	public void update() 
	{
		...
		if(!this.world.isRemote) 
		{
			...
			{
				flag1 = true;
				InfusionAltarBlock.setState(this.isBurning(), this.world, this.pos);
			}
		} 
	...
	public int getGuiID() 
	{
		return Reference.GUI_INFUSION_ALTAR;
	}
